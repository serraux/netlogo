...
to setup
  ...
  create-turtles 2; create one turtle
  ask turtle 0
  [
    set shape "circle"
    setxy 0 0
    set heading 45  ; set heading to 90 degrees (facing upward)
  ]
 ask turtle 1
  [
    set shape "circle"
...
Try to press the go button a couple of time  to see how the color of turtles change.
